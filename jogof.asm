...
.text
	...
	verificaFimJogo:
		...
		verificaFimJogo1:
			bne $t1, 3, verificaFimJogo1.end
			li $t2, 0
			verificaFimJogo2:
				bne $t2, 3, verificaFimJogo2.end
				li $t3, 0
				verificaFimJogo3:
					bne $t3, 3, verificaFimJogo3.end
					li $t4, 0
					verificaFimJogo4:
						bne $t4, 3, verificaFimJogo4.end
						li $t5, 0
						verificaFimJogo5:
							bne $t5, 3, verificaFimJogo5.end
							li $t6, 0
							verificaFimJogo6:
								bne $t6, 3, verificaFimJogo6.end
								li $t7, 0
								verificaFimJogo7:
									bne $t7, 3, verificaFimJogo7.end
									li $t7, 0
									verificaFimJogo8:
										bne $t7, 3, verificaFimJogo8.end
										li $t7, 0
										verificaFimJogo9:
											bne $t7, 3, verificaFimJogo9.end
											li $t7, 0
											verificaFimJogo10:
												bne $t7, 3, verificaFimJogo10.end
												li $t7, 0
												verificaFimJogo11:
													bne $t7, 3, verificaFimJogo11.end
													li $t7, 0
													verificaFimJogo12:
														bne $t7, 3, verificaFimJogo12.end
														li $t7, 0
														verificaFimJogo13:
															bne $t7, 3, verificaFimJogo13.end
															li $t7, 0
															verificaF
